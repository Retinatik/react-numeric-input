...
/***/ (function(module, exports, __webpack_require__) {
	...
	NumericInput.propTypes = {
	    step: _propTypes.PropTypes.number,
	    ...
	    parse: _propTypes.PropTypes.func,
	    format: _propTypes.PropTypes.func,
	    className: _propTypes.PropTypes.string,
	    disabled: _propTypes.PropTypes.bool,
	    readOnly: _propTypes.PropTypes.bool,
	    required: _propTypes.PropTypes.bool,
	    noValidate: _propTypes.PropTypes.oneOfType([_propTypes.PropTypes.bool, _propTypes.PropTypes.string]),
	    style: _propTypes.PropTypes.oneOfType([_propTypes.PropTypes.object, _propTypes.PropTypes.bool]),
	    ...
	    onInvalid: _propTypes.PropTypes.func,
	    onValid: _propTypes.PropTypes.func,
	    onInput: _propTypes.PropTypes.func,
	    onSelect: _propTypes.PropTypes.func,
	    size: _propTypes.PropTypes.oneOfType([_propTypes.PropTypes.number, _propTypes.PropTypes.string]),
	    value: _propTypes.PropTypes.oneOfType([_propTypes.PropTypes.number, _propTypes.PropTypes.string]),
	    defaultValue: _propTypes.PropTypes.oneOfType([_propTypes.PropTypes.number, _propTypes.PropTypes.string]),
